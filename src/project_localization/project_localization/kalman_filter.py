...
class KalmanFilter(Node):
    ...
    def __init__(self):
        ...
        self.odom_sub_ = self.create_subscription(Odometry, "robot1/odom", self.odomCallback, 10)
        self.imu_sub_ = self.create_subscription(Imu, "imu", self.imuCallback, 10)
        self.odom_pub_ = self.create_publisher(Odometry, "robot1/odom_filtered", 10)
